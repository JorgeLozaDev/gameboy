  ...
  if (this.classList.contains("encendido")) {
    ...
    setTimeout(() => {
      ...
      pantalla[0].innerHTML =
        "<video  preload='none' id='video' src='src/img/onVideo.mp4'></video>";
...
// creamos esta funcion para que cuando se de click en el boton de reset podamos volver al menu principal
